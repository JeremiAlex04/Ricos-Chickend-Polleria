...
<section class="productos">
     <div class="container">
        ...
        <p>Explora todo lo que tenemos para ti. ¡Hecho con amor y tradición!</p>
        ...
        <?php else : ?>
            <p style="margin-top: 2rem; font-size: 1.2rem;">No hay productos disponibles en este momento.</p>
        <?php endif; ?>
